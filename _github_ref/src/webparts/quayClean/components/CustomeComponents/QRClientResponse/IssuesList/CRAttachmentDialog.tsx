...
import { getClientResponseAttachments } from "../../../CommonComponents/CommonMethods";
...
const CRAttachmentDialog: React.FC<IAttachmentDialogProps> = ({ isOpen, onClose, selectedItem, isView }) => {
        ...
        if (selectedItem) {
            (async () => {
                ...
                if (isView) {
                    ...
                    const data = await getClientResponseAttachments(provider, context, selectedItem);
                    setAttachments(data);
                }
                setCurrentIndex(0);
                setIsLoading(false);
        ...
        <>
            ...
            >
                <div className={contentStyles.header}>
                    <h2 className={contentStyles.heading} id="titleId">Client Feedback Attachments</h2>
                    <IconButton
...
export default CRAttachmentDialog;
