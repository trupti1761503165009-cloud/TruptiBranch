...
export const ClientResponsePrintQrCode = (props: IPrintQrCodeProps) => {
    ...
    const handleDownloadQrImage = async () => {
        if (downloadRef.current) {
            ...
            link.href = dataUrl;
            // link.download = `${siteName}_${props.selectedItem?.SiteArea}_QRCode_${time}.png`;
            link.download = `${siteName}_Client_Response_QRCode_${time}.png`;
            link.click();
            setIsLoading(false);
        }
    };
                        ...
                        <div className="print-container" id="HazardQRCode" ref={printRef}>
                            <div className="card" ref={downloadRef}>
                                ...
                                <div className="qrcode-box">
                                    <img src={props.selectedItem?.QRCodeUrl} alt="QR Code" className="qclogoims" />
                                </div>
                                <div className="subtitle">{ClientResponseViewFields.LogoTitle}</div>
