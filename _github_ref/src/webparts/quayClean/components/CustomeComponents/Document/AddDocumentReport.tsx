...
const AddDocumentReport: React.FC<Props> = ({ data, isChartOnly }) => {
    ...
    const drawLevel1 = () => {
        ...
        chartInstance.current?.setOption({
            title: { text: 'Document Activity by Site Name', left: 'center' },
    ...
    const drawLevel2 = (siteName: string) => {
        ...
        chartInstance.current?.off('click');
        chartInstance.current?.setOption({
            title: { text: `Document Entities in ${siteName}`, left: 'center' },
    ...
    const drawLevel3 = (siteName: string, entityName: string) => {
        ...
        chartInstance.current?.off('click');
        chartInstance.current?.setOption({
            title: { text: `Document Actions on ${entityName} in ${siteName}`, left: 'center' },
    ...
    const drawLevel4 = (siteName: string, entityName: string, actionType: string) => {
        ...
        chartInstance.current?.off('click');
        chartInstance.current?.setOption({
            title: { text: `Document by Users for ${actionType} on ${entityName}`, left: 'center' },
...
export default AddDocumentReport;
