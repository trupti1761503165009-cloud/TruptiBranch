...
import { WHSMeetingGridData } from "./WHSMeetingGridData"
...
import { WHSMeetingCountCard } from "./WHSMeetingCountCard"

export interface IWHSMeetingGridProps {
...
export const WHSMeetingGrid = (props: IWHSMeetingGridProps) => {
    const appGlobalState = useAtomValue(appGlobalStateAtom);
    const { provider, context } = appGlobalState;
    const { state, _onItemInvoked, _onItemSelected, onChangeFromDate, onChangeRangeOption, onChangeToDate, toDate, fromDate, onCloseDialogSucess, handleCardClick, onChangeLocationFilter, onClickDeleteIcon, onclickExportToExcel } = WHSMeetingGridData(props)
    ...
    return <div >
        ...
        <div className={props.isDirectView ? "boxCard" : ""}>
            ...
            {/* <ToolboxTalkCountCard data={state.summaryData} handleCardClick={handleCardClick} /> */}
            <div className="formgroup eql-height-periodic">
                {props.isDirectView && <div className="ms-Grid-row">
                    <div className="ms-Grid-col ms-sm12 ms-md12 ms-lg12">
                        <h1 className="mainTitle">WHS Committee Meeting</h1>
                    </div>
                </div>}
