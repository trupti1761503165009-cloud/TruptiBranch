...
import { ActiveUsersTrendData } from "./ActiveUsersTrendData";
import NoRecordFound from "../../../../CommonComponents/NoRecordFound";
import ActivityUserTrendLineChart from "./ActivityUserTrendLineChart";
import CommonPopup from "../../../../CommonComponents/CommonSendEmailPopup";
import { PrimaryButton } from "@fluentui/react";
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";
import { Loader } from "../../../../CommonComponents/Loader";

export interface IActiveUsersTrendProps {
...
export const ActiveUsersTrend = (props: IActiveUsersTrendProps) => {
    const {
        state,
        onClickDownload,
        onClickCancel,
    ...
    return <div className="ms-Grid-row systemLevel">
        ...
        <div id="ActiveUsersTrend">
            <div className="ms-Grid-col ms-sm12 ms-md12 ms-lg12 report-col-width ">
                {/* <h1>{props.isGenratePdf ? "Yes" : "No"}</h1> */}
                <ActivityUserTrendLineChart chartData={state.items || []}
                            ...
                            <table className="sites-table ">
                                <thead>
                                    <tr className="systemUse ">
                                        <th className="site-cell">Date</th>
                                        <th className="site-cell">Unique Active Users</th>
