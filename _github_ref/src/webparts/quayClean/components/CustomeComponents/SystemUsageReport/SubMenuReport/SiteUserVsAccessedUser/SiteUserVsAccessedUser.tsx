...
import { SiteUserVsAccessedUserData } from "./SiteUserVsAccessedUserData";
import NoRecordFound from "../../../../CommonComponents/NoRecordFound";
import { SiteUserVsAccessedUserChart } from "./SiteUserVsAccessedUserChart";
...
export interface ISiteUserVsAccessedUserProps {
...
export const SiteUserVsAccessedUser = (props: ISiteUserVsAccessedUserProps) => {
    const { state,
        onClickDownload,
        onClickCancel,
        onChangeTitle,
    ...
    } = SiteUserVsAccessedUserData(props);
    ...
    const renderRows = (
        ...
        return nodes.map((node: any, index: number) => (
            <SiteRow
                key={index}
                label={node?.StateName}
                labelTwo={node.Title}
                labelTheree={node.totalUserCount}
        ...
        return (
            <>
                ...
                >
                    ...
                    <td className="site-cell">{props?.labelFive == 0 ?
                        // <span>{props.labelFive} {" "} <FontAwesomeIcon icon={faInfoCircle} /></span>
                        <span className="dflex ">{props.labelFive} {" "}
                            <Link className="actionBtn btnMoving dticon ml-10">
                                <TooltipHost content={"Assigned Users (Site Manager, Site Supervisor, and Client) vs Active Users (Assigned Users Count)"} >
    ...
    return <div className="ms-Grid-row systemLevel">
        ...
        <div id="SiteUserVsAccessedUser">
            <div className="ms-Grid-col ms-sm12 ms-md12 ms-lg12">
                <SiteUserVsAccessedUserChart chartData={state.items || []} isGeneratePdf={state.isGenratePDF} />
            </div>
                        ...
                        <table className="sites-table ">
                            <thead>
                                <tr className="systemUse ">
                                    ...
                                    <th className="site-cell">Assigned Users</th>
                                    <th className="site-cell">Active Users</th>
                                    <th className="site-cell">Users Gap</th>
                                </tr>
                            </thead>
                            <tbody>
                                <>
