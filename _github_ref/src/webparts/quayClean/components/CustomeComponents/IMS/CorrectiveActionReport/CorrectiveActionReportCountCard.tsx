...
export const CorrectiveActionReportCountCard = (props: ICountCard) => {
    ...
    const cardConfig: any = {
        "Total Corrective Action Report": {
            cardClass: "TotalCard",
        ...
        <>
            <div className="collapsible-section quaysafeCountCard m-0">
                ...
                <div className={`pageTopCount ${isCollapsed ? 'hidden' : ''}`}>
                    ...
                    {/* TOTAL CORRECTIVE ACTION REPORT */}
                    <div
                        className={getCardClassName('Total Corrective Action Report')}
                        onClick={() => handleCardClickInternal('Total Corrective Action Report')}>
                        <div className="card-content">
                            <img src={total} alt="Corrective Action Report Icon" />
                            <div className="card-block-text">
                                <h3 className={cardConfig["Total Corrective Action Report"].colorClass}>
                                    Total Corrective Action Report
                                </h3>
                                <p className={`card-number ${cardConfig["Total Corrective Action Report"].colorClass}`}>
                                    {data?.totalCorrectiveActionReport}
                                </p>
                            </div>
                        </div>
                        <div className={`pattern ${cardConfig["Total Corrective Action Report"].patternClass}`}></div>
                        {activeCard === "Total Corrective Action Report" && (
...
//                     className={getCardClassName('Total Corrective Action Report')}
//                     onClick={() => handleCardClickInternal('Total Corrective Action Report')}>
//                     <h3>Total Corrective Action Report</h3>
//                     <div className="card-content">
//                         <img src={total} alt="Corrective Action Report Icon" />
//                         <p className="card-number">{data?.totalCorrectiveActionReport}</p>
//                     </div>
//                 </div>
//                 {/* <div
