...
export const ToolboxIncidentCountCard = (props: ICountCard) => {
        ...
        <>
            <div className="collapsible-section quaysafeCountCard m-0">
                ...
                <div className={`pageTopCount ${isCollapsed ? 'hidden' : ''}`}>
                    ...
                    {/* TOTAL TOOLBOX INCIDENT */}
                    <div
                        className={getCardClassName('Total Toolbox Incident')}
                        onClick={() => handleCardClickInternal('Total Toolbox Incident')}>
                        <div className="card-content">
                            <img src={total} alt="Toolbox Incident Icon" />
                            <div className="card-block-text">
                                <h3 className={cardConfig["Total Toolbox Incident"].colorClass}>
                                    Total Toolbox Incident
                                </h3>
                                <p className={`card-number ${cardConfig["Total Toolbox Incident"].colorClass}`}>
                                    {data?.totalToolboxIncident}
                                </p>
                            </div>
                        </div>
                        <div className={`pattern ${cardConfig["Total Toolbox Incident"].patternClass}`}></div>
                        {activeCard === "Total Toolbox Incident" && (
...
//                     className={getCardClassName('Total Toolbox Incident')}
//                     onClick={() => handleCardClickInternal('Total Toolbox Incident')}>
//                     <h3>Total Toolbox Incident</h3>
//                     <div className="card-content">
//                         <img src={total} alt="Toolbox Incident Icon" />
//                         <p className="card-number">{data?.totalToolboxIncident}</p>
//                     </div>
//                 </div>
