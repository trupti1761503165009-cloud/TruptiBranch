...
export const WorkplaceCardView = (props: ICardProps) => {
    ...
    const onViewClick = (data: any): void => {
        props.manageComponentView({
            currentComponentName: ComponentNameEnum.DetailWorkplaceInspection,
                                ...
                                <div className="thumbCard">
                                    <div className="thumbTitle position-relative">
                                        ...
                                        {/* <a className="" href="#" id="navbarDropdown" role="button">
                                            <Link className="actionBtn btnView" onClick={() => {
                                                onViewClick(data)
                                            }}>
                                    ...
                                    <div className="row fnt-14 mx-0 ">
                                        <div className="card-other-content">
                                            <label className="card-label">Workplace Inspection Id</label>
