...
export const ToolboxCardView = (props: ICardProps) => {
                                ...
                                <div className="thumbCard">
                                    ...
                                    <div className="row fnt-14 mx-0 ">
                                        <div className="card-other-content">
                                            <label className="card-label">Meeting</label>
                                            <div className="fw-medium">{data.MeetingID}</div>
                                        </div>
                                        <div className="card-other-content">
                                            <label className="card-label">Meeting Date</label>
                                            <div className="fw-medium">{data.MeetingDate}</div>
                                        </div>
                                        <div className="card-other-content">
                                        ...
                                        <div className="card-other-content">
                                            <label className="card-label">Minutes Taken And Recorded By</label>
                                            <div className="fw-medium">{data.MinutesTakenAndRecordedBy}</div>
                                        </div>
                                        <div className="card-other-content">
