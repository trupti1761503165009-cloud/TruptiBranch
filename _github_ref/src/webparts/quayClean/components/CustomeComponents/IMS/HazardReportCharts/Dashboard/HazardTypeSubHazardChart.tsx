...
const HazardTypeSubHazardLineChart: React.FC<ReportProps> = ({ data, width, title, height }) => {
        ...
        chart.setOption({
            ...
            tooltip: {
                ...
                formatter: (params: any) => {
                    ...
                    const hazardType = params[0]?.name ?? "Unknown";
            ...
            toolbox: getToolbox(),
            xAxis: { type: "category", data: hazardTypes, axisLabel: { rotate: 15, interval: 0 } },
            yAxis: { type: "value" },
            series
        }, true);
    };
...
export default HazardTypeSubHazardLineChart;
