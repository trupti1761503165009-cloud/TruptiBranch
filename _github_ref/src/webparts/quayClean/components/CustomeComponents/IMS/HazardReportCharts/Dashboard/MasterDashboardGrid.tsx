...
export const MasterDashboardGrid: React.FC<HazardGridProps> = ({ data, isPDFGenerating, siteName }) => {
            ...
            <>
                {isSubmission ? (
                    <tr className="site-row siteLevelSubmission">
                        ...
                        <td className='site-cell'>{node.hazardType}</td>
                        <td className='site-cell'>{node.subHazard}</td>
        ...
        if (siteName) {
            return nodes.map((sub, idx) => (
                <tr key={idx} className="site-row siteLevelSubmission">
                    <td className='site-cell'>{sub.hazardType}</td>
                    <td className='site-cell'>{sub.subHazard}</td>
