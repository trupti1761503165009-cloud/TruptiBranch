...
export const MicrokeeperDocumantation = (props: IQuaycleanProps) => {
    ...
    return <>
        <div className='ms-Grid-row p-14'>
            <div className='ms-md12 ms-sm12 ms-Grid-col mb-3'>
                <div className='dashboard-card p00'>
                    <div className='height211 lightgrey2'>
                        <div className="doc-body-microkeeper">
                            <div className="doc-container-microkeeper">
