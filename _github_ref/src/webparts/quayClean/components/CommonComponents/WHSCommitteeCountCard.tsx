...
let repair = require('../../assets/images/Quaysafe/repair.png');
...
export const WHSCommitteeCountCard = (props: IEquipmentCountCard) => {
    ...
    const cardConfig: any = {
        ...
        "Total Unique Chairperson": {
            cardClass: "RepairCard",
            colorClass: "RepairCardColor",
            patternClass: "RepairCard-pattern"
        },
        "Completed Signature": {
    ...
    return (
        <>
            <div className="collapsible-section hazardCountCard m-0">
                ...
                <div className={`pageTopCount ${isCollapsed ? 'hidden' : ''}`}>
                    ...
                    {/* TOTAL WHS COMMITTEE */}
                    <div
                        className={getCardClassName('Total WHS Committee')}
                        onClick={() => handleCardClickInternal('Total WHS Committee')}>
                        <div className="card-content">
                            <img src={total} alt="WHS Committee Icon" />
                            <div className="card-block-text">
                                <h3 className={cardConfig["Total WHS Committee"].colorClass}>
                                    Total WHS Committee
                                </h3>
                                <p className={`card-number ${cardConfig["Total WHS Committee"].colorClass}`}>
                                    {data?.totalWHSCommittee}
                                </p>
                            </div>
                        </div>
                        <div className={`pattern ${cardConfig["Total WHS Committee"].patternClass}`}></div>
                        {activeCard === "Total WHS Committee" && (
                    ...
                    {/* TOTAL UNIQUE CHAIRPERSON */}
                    <div
                        className={getCardClassName('Total Unique Chairperson')}
                        onClick={() => handleCardClickInternal('Total Unique Chairperson')}>
                        <div className="card-content">
                            <img src={repair} alt="Chairperson Icon" />
                            <div className="card-block-text">
                                <h3 className={cardConfig["Total Unique Chairperson"].colorClass}>
                                    Total Unique Chairperson
                                </h3>
                                <p className={`card-number ${cardConfig["Total Unique Chairperson"].colorClass}`}>
                                    {data?.totalUniqueUsers}
                                </p>
                            </div>
                        </div>
                        <div className={`pattern ${cardConfig["Total Unique Chairperson"].patternClass}`}></div>
                        {activeCard === "Total Unique Chairperson" && (
                            <div className="filter-icon-wrapper">
                                <TooltipHost content="Filter Applied">
                                    <FontAwesomeIcon icon={faFilter} className="filter-icon" />
                                </TooltipHost>
...
//                     onClick={() => handleCardClickInternal('Total WHS Committee')}
//                 >
//                     <h3>Total WHS Committee</h3>
//                     <div className="card-content">
//                         <img src={total} alt="WHS Committee Icon" />
//                         <p className="card-number">{data?.totalWHSCommittee}</p>
//                     </div>
//                 </div>
//                 {/* <div
...
//                         <p className="card-number">{formatPrice(data?.totalSiteValue || 0)}</p>
//                     </div>
//                 </div> */}
//                 <div
//                     className={getCardClassName('Total Submitted')}
...
//                     onClick={() => handleCardClickInternal('Total Unique Chairperson')}
//                 >
//                     <h3>Total Unique Chairperson</h3>
//                     <div className="card-content">
//                         <img src={repair} alt="Repairs Icon" />
//                         <p className="card-number">{data?.totalUniqueUsers}</p>
//                     </div>
//                 </div>
//                 <div
//                     className={getCardClassName('Completed Signature')}
