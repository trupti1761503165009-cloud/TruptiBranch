...
export const AddSingleOtherEmployee: React.FunctionComponent<IAddEmployeeProps> = (props: IAddEmployeeProps): React.ReactElement => {
        ...
        try {
            ...
            if (!isValid) {
                ...
                const data = {
                    ...
                    Phone: objData.phone ? objData.phone.trim() : '',
                ...
                try {
                    ...
                    if (drpOption.length > 0) {
                        props.onEmployeeChange(drpOption[0]);
                    } else {
                        props.onEmployeeChange(transformedItem);
                    }
    ...
    const getQuaycleanEmployeeList = async (): Promise<void> => {
        ...
        //     dropvalue.push({ key: '', text: '', value: 'All', label: label });
        // }
        // const select = ["Id,FirstName,LastName,StateId,State/Title,Email,Phone"];
        // const expand = ["State"];
        // let filter;
