...
export const PreDateRangeFilterInspection: React.FunctionComponent<IDaterangeFilterProps> = (props: IDaterangeFilterProps): React.ReactElement => {
    ...
    const [selectedOption, setSelectedOption] = React.useState<IDropdownOption>({ key: "Last 7 Days", text: "Last 7 Days" });
