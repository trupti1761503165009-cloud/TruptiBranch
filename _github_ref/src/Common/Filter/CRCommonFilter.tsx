...
interface ICRCommonFilterProps {
    selectedHD: number;
    onCRChange: (assetTypeId: string) => void;
...
export const CRCommonFilter: React.FunctionComponent<ICRCommonFilterProps> = (props: ICRCommonFilterProps): React.ReactElement => {

    const _onCRChange = (option: any, actionMeta: ActionMeta<any>): void => {
        props.onCRChange(option.text as string);
    ...
    return <>
                ...
                >
                    ...
                    <FocusTrapZone>
                        <div role="document" className={popupStyles.content}>
                            <h2 className="mt-10">Add Client Response choice</h2>
        ...
        <div>
            ...
            <div className={props?.isReq && !defaultvalue && !props?.defaultOption ? "" : ""}>
                <ReactDropdown
