...
// export const SynergySessions = (props: IAssociateChemicalProps) => {
...
//             if (props.siteName) {
//                 folderPath = context.pageContext.web.serverRelativeUrl + "/SynergySessions/" + props.siteName;
//             } else {
//                 folderPath = context.pageContext.web.serverRelativeUrl + "/SynergySessions";
//             }
//         } else {
//             folderPath = link;
//         }
...
//         }
//         let allFoldersfiles = await provider.getItemsByCAMLQuery("SynergySessions", camlQuery.ToString());
...
//             if (link == "" || link == undefined) {
//                 if (props.siteName) {
//                     folderPath = "/SynergySessions/" + props.siteName;
//                 } else {
//                     folderPath = "/SynergySessions"
//                 }
...
//                     return (
//                         <div className="container-document" style={{ display: "flex", alignItems: "center", gap: 8 }}>
//                             <Link onClick={() => {
...
//             } else {
//                 newFolderName = `${context.pageContext.web.serverRelativeUrl}/${"SynergySessions"}/${props.siteName}/${title}`;
//             }
//         }
...
//                     } else {
//                         newFolderName = `${context.pageContext.web.serverRelativeUrl}/${"SynergySessions"}/${props.siteName}`;
//                     }
//                 }
//             } else {
...
//                 StateNameId: selectedType === "State" ? selectedState : [],
//             };
//             await provider.updateItemWithPnP(UpdateObj, ListNames.SynergySessions, Number(updateItemId.current));
...
//                     <h1 className="mainTitle">Safetember</h1>
//                 </div>}
...
//                                         key: `${context.pageContext.web.serverRelativeUrl}/${"SynergySessions"}/${props.siteName}`,
//                                         text: `${props.siteName}`
//                                     }}
...
//                                     siteServerRelativeURL={`${context.pageContext.web.serverRelativeUrl}`}
//                                     parentBreadCrumbItem={{
//                                         key: `${context.pageContext.web.serverRelativeUrl}/${"SynergySessions"}`,
//                                         text: `${"Safetember"}`
//                                     }}
//                                     setSourcePath={setSourcePath} // set a new path when click on breadcrumb item.
//                                     newBreadcrumbItem={newBreadcrumbItem || undefined} // add a new item in breadcrumb when folder is clicked
