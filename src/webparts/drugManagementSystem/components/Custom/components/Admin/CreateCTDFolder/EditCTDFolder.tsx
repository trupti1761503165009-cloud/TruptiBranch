...
export const EditCTDFolder: React.FC<any> = (props) => {
    const {
        folders,
        selectedParent,
        newFolderCode,
        ...
        handleEditConfirm,
        openEditPanel, // We use this to set the editing folder state in the hook
    ...
    React.useEffect(() => {
        if (props.componentProps && props.componentProps.item) {
            const folder = props.componentProps.item;
            // We must tell the hook which folder we are editing
    ...
    const handleFormSave = async () => {
        ...
        const success = await handleEditConfirm();
        if (success) {
            handleCancel();
        }
    };
                    ...
                    <div className="ms-Grid">
                        ...
                        <div className="ms-Grid-row">
                            <div className="ms-Grid-col ms-sm12 ms-md12 ms-lg12 dFlex justifyContentBetween alignItemsCenter">
                                <div>
                                    <h1 className="mainTitle">Edit CTD Folder</h1>
                                </div>
                                <div>
                                    <PrimaryButton
                                ...
                                <div className="customebreadcrumb">
                                    <Breadcrumb
                                        items={[
                                            ...
                                            { label: 'Edit Folder', isActive: true }
                                        ]}
                                    />
                                </div>
                            </div>
                                ...
                                <div className="ms-Grid-row" style={{ marginTop: 16 }}>
                                    <div className="ms-Grid-col ms-sm12 ms-md6 ms-lg6">
                                        ...
                                        <ReactDropdown
                                            ...
                                            onChange={(opt) => setSelectedParent(opt?.value ?? '')}
