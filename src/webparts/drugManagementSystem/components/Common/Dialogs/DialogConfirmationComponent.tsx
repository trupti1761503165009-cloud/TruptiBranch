    ...
    return (
        <>
            ...
            >
                {props.children}
                <DialogFooter>
                    <PrimaryButton onClick={props.yesClick} text={`${props.yesText}`} className='firstMain' />
                    <PrimaryButton onClick={props.toggleHideDialog} text={`${props.noText}`} className='firstMain' />
                </DialogFooter>
            </Dialog>
        </>
    );
