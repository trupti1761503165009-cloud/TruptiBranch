                ...
                <div className="modal-footer-container">
                    <div className="d-flex justifyright customButton">
                        {!!props?.onClickOfRemove &&
                            <DefaultButton disabled={!!props.isLoading || (!!props.isRemoveButtonDisbale ? props.isRemoveButtonDisbale : false)} style={{ marginRight: "5px" }}
                        ...
                        {!!props?.onClickOfYes &&
                            <DefaultButton disabled={!!props.isLoading || (!!props.isYesButtonDisbale ? props.isYesButtonDisbale : false)} style={{ marginRight: "5px" }}
                        ...
                        {!!props.closeButtonText && <DefaultButton disabled={!!props.isLoading} className="btn btn-danger" onClick={() => hideModalEvent()} text={props.closeButtonText} />
                        }
                        {!!props.onClickThirdButton && <DefaultButton disabled={!!props.isLoading} className="btn btn-gray" style={{ marginLeft: "5px" }} onClick={() => !!props.onClickThirdButton && props.onClickThirdButton()} text={props.thirdButtonText} />
                        }
